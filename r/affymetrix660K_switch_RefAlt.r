info1=read.table("660K_info.txt",head=T)
info2_1=read.table("pig_660k_A584400_info2.txt",head=T)
info2_2=read.table("pig_660k_B44766_info2.txt",head=T)
...
dim(info7)
write.table(info7,"Axiom_PigSNP660K_623638.info", row.names = FALSE, col.names =FALSE, quote =FALSE)
...
#dim(info6)
#write.table(info7,"Axiom_PigSNP660K_623618.info", row.names = FALSE, col.names =FALSE, quote =FALSE)
