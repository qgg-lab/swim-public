info1=read.table("60K_info.txt",head=T)
info2=read.table("pig_60k_53408_info2.txt",head=T)
...
info3$QUAL="."
info3$INFO="PorcineSNP60K"

info4= info3[!is.na(info3$alt),]
info5=subset(info4,select=c(chr,pos,Name,REF,alt,QUAL,QUAL,INFO))
nrow(info5)
write.table(info5,"PorcineSNP60K_52866.info", row.names = FALSE, col.names =FALSE, quote =FALSE)
