info1=read.table("50K_info.txt",head=T)
info2=read.table("pig_50k_45579_info2.txt",head=T)
...
info3$QUAL="."
info3$INFO="PorcineSNP50K"

info4= info3[!is.na(info3$alt),]
info5=subset(info4,select=c(chr,pos,Name,REF,alt,QUAL,QUAL,INFO))
nrow(info5)
write.table(info5,"PorcineSNP50K_45164.info", row.names = FALSE, col.names =FALSE, quote =FALSE)
